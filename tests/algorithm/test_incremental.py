...
def test_all_algorithm_npp_100(capfd):
    ...
    pipeline = Incremental.create_pipeline(
    ...
    assert (
        "[47, 60, 87, 60, 91, 71, 28, 37, 7, 65, 28, 29, 38, 55, 6, 75, 57, 49, 34, 83, "
        "30, 46, 78, 29, 99, 32, 86, 82, 7, 81, 90, 12, 20, 65, 42, 20, 47, 7, 52, 78]" in out
    )  # 1--40
